<?php
//prevent Content-Security-Policy header
...
<html class="no-js" lang="en">
  <head>
    ...
    <script src="js/vendor/modernizr.js"></script>
     ...
     <!-- Add Content-Security-Policy header to prevent Content Security Policy (CSP) vulnerability -->
    ...
    <nav class="top-bar" data-topbar role="navigation">
      ...
      <!-- Right Nav Section -->
        <ul class="right">
          ...
          <li><a href="3-login.php">Google Login</a></li>
